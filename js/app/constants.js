...
(function () {
  ...
  /* map wotlk constants */
  app.modalConstants.mapWotlk = [];
  app.modalConstants.mapWotlk[0] = "Eastern Kingdoms";
  app.modalConstants.mapWotlk[1] = "Kalimdor";
  app.modalConstants.mapWotlk[13] = "Testing";
  app.modalConstants.mapWotlk[25] = "Scott Test";
  app.modalConstants.mapWotlk[30] = "Alterac Valley";
  app.modalConstants.mapWotlk[33] = "Shadowfang Keep";
  app.modalConstants.mapWotlk[34] = "Stormwind Stockade";
  app.modalConstants.mapWotlk[35] = "<unused>StormwindPrison";
  app.modalConstants.mapWotlk[36] = "Deadmines";
  app.modalConstants.mapWotlk[37] = "Azshara Crater";
  app.modalConstants.mapWotlk[42] = "Collin's Test";
  app.modalConstants.mapWotlk[43] = "Wailing Caverns";
  app.modalConstants.mapWotlk[44] = "<unused> Monastery";
  app.modalConstants.mapWotlk[47] = "Razorfen Kraul";
  app.modalConstants.mapWotlk[48] = "Blackfathom Deeps";
  app.modalConstants.mapWotlk[70] = "Uldaman";
  app.modalConstants.mapWotlk[90] = "Gnomeregan";
  app.modalConstants.mapWotlk[109] = "Sunken Temple";
  app.modalConstants.mapWotlk[129] = "Razorfen Downs";
  app.modalConstants.mapWotlk[169] = "Emerald Dream";
  app.modalConstants.mapWotlk[189] = "Scarlet Monastery";
  app.modalConstants.mapWotlk[209] = "Zul'Farrak";
  app.modalConstants.mapWotlk[229] = "Blackrock Spire";
  app.modalConstants.mapWotlk[230] = "Blackrock Depths";
  app.modalConstants.mapWotlk[249] = "Onyxia's Lair";
  app.modalConstants.mapWotlk[269] = "Opening of the Dark Portal";
  app.modalConstants.mapWotlk[289] = "Scholomance";
  app.modalConstants.mapWotlk[309] = "Zul'Gurub";
  app.modalConstants.mapWotlk[329] = "Stratholme";
  app.modalConstants.mapWotlk[349] = "Maraudon";
  app.modalConstants.mapWotlk[369] = "Deeprun Tram";
  app.modalConstants.mapWotlk[389] = "Ragefire Chasm";
  app.modalConstants.mapWotlk[409] = "Molten Core";
  app.modalConstants.mapWotlk[429] = "Dire Maul";
  app.modalConstants.mapWotlk[449] = "Alliance PVP Barracks";
  app.modalConstants.mapWotlk[450] = "Horde PVP Barracks";
  app.modalConstants.mapWotlk[451] = "Development Land";
  app.modalConstants.mapWotlk[469] = "Blackwing Lair";
  app.modalConstants.mapWotlk[489] = "Warsong Gulch";
  app.modalConstants.mapWotlk[509] = "Ruins of Ahn'Qiraj";
  app.modalConstants.mapWotlk[529] = "Arathi Basin";
  app.modalConstants.mapWotlk[530] = "Outland";
  app.modalConstants.mapWotlk[531] = "Ahn'Qiraj Temple";
  app.modalConstants.mapWotlk[532] = "Karazhan";
  app.modalConstants.mapWotlk[533] = "Naxxramas";
  app.modalConstants.mapWotlk[534] = "The Battle for Mount Hyjal";
  app.modalConstants.mapWotlk[540] = "Hellfire Citadel: The Shattered Halls";
  app.modalConstants.mapWotlk[542] = "Hellfire Citadel: The Blood Furnace";
  app.modalConstants.mapWotlk[543] = "Hellfire Citadel: Ramparts";
  app.modalConstants.mapWotlk[544] = "Magtheridon's Lair";
  app.modalConstants.mapWotlk[545] = "Coilfang: The Steamvault";
  app.modalConstants.mapWotlk[546] = "Coilfang: The Underbog";
  app.modalConstants.mapWotlk[547] = "Coilfang: The Slave Pens";
  app.modalConstants.mapWotlk[548] = "Coilfang: Serpentshrine Cavern";
  app.modalConstants.mapWotlk[550] = "Tempest Keep";
  app.modalConstants.mapWotlk[552] = "Tempest Keep: The Arcatraz";
  app.modalConstants.mapWotlk[553] = "Tempest Keep: The Botanica";
  app.modalConstants.mapWotlk[554] = "Tempest Keep: The Mechanar";
  app.modalConstants.mapWotlk[555] = "Auchindoun: Shadow Labyrinth";
  app.modalConstants.mapWotlk[556] = "Auchindoun: Sethekk Halls";
  app.modalConstants.mapWotlk[557] = "Auchindoun: Mana-Tombs";
  app.modalConstants.mapWotlk[558] = "Auchindoun: Auchenai Crypts";
  app.modalConstants.mapWotlk[559] = "Nagrand Arena";
  app.modalConstants.mapWotlk[560] = "The Escape From Durnholde";
  app.modalConstants.mapWotlk[562] = "Blade's Edge Arena";
  app.modalConstants.mapWotlk[564] = "Black Temple";
  app.modalConstants.mapWotlk[565] = "Gruul's Lair";
  app.modalConstants.mapWotlk[566] = "Eye of the Storm";
  app.modalConstants.mapWotlk[568] = "Zul'Aman";
  app.modalConstants.mapWotlk[571] = "Northrend";
  app.modalConstants.mapWotlk[572] = "Ruins of Lordaeron";
  app.modalConstants.mapWotlk[573] = "ExteriorTest";
  app.modalConstants.mapWotlk[574] = "Utgarde Keep";
  app.modalConstants.mapWotlk[575] = "Utgarde Pinnacle";
  app.modalConstants.mapWotlk[576] = "The Nexus";
  app.modalConstants.mapWotlk[578] = "The Oculus";
  app.modalConstants.mapWotlk[580] = "The Sunwell";
  app.modalConstants.mapWotlk[582] = "Transport: Rut'theran to Auberdine";
  app.modalConstants.mapWotlk[584] = "Transport: Menethil to Theramore";
  app.modalConstants.mapWotlk[585] = "Magister's Terrace";
  app.modalConstants.mapWotlk[586] = "Transport: Exodar to Auberdine";
  app.modalConstants.mapWotlk[587] = "Transport: Feathermoon Ferry";
  app.modalConstants.mapWotlk[588] = "Transport: Menethil to Auberdine";
  app.modalConstants.mapWotlk[589] = "Transport: Orgrimmar to Grom'Gol";
  app.modalConstants.mapWotlk[590] = "Transport: Grom'Gol to Undercity";
  app.modalConstants.mapWotlk[591] = "Transport: Undercity to Orgrimmar";
  app.modalConstants.mapWotlk[592] = "Transport: Borean Tundra Test";
  app.modalConstants.mapWotlk[593] = "Transport: Booty Bay to Ratchet";
  app.modalConstants.mapWotlk[594] = "Transport: Howling Fjord Sister Mercy (Quest)";
  app.modalConstants.mapWotlk[595] = "The Culling of Stratholme";
  app.modalConstants.mapWotlk[596] = "Transport: Naglfar";
  app.modalConstants.mapWotlk[597] = "Craig Test";
  app.modalConstants.mapWotlk[598] = "Sunwell Fix (Unused)";
  app.modalConstants.mapWotlk[599] = "Halls of Stone";
  app.modalConstants.mapWotlk[600] = "Drak'Tharon Keep";
  app.modalConstants.mapWotlk[601] = "Azjol-Nerub";
  app.modalConstants.mapWotlk[602] = "Halls of Lightning";
  app.modalConstants.mapWotlk[603] = "Ulduar";
  app.modalConstants.mapWotlk[604] = "Gundrak";
  app.modalConstants.mapWotlk[605] = "Development Land (non-weighted textures)";
  app.modalConstants.mapWotlk[606] = "QA and DVD";
  app.modalConstants.mapWotlk[607] = "Strand of the Ancients";
  app.modalConstants.mapWotlk[608] = "Violet Hold";
  app.modalConstants.mapWotlk[609] = "Ebon Hold";
  app.modalConstants.mapWotlk[610] = "Transport: Tirisfal to Vengeance Landing";
  app.modalConstants.mapWotlk[612] = "Transport: Menethil to Valgarde";
  app.modalConstants.mapWotlk[613] = "Transport: Orgrimmar to Warsong Hold";
  app.modalConstants.mapWotlk[614] = "Transport: Stormwind to Valiance Keep";
  app.modalConstants.mapWotlk[615] = "The Obsidian Sanctum";
  app.modalConstants.mapWotlk[616] = "The Eye of Eternity";
  app.modalConstants.mapWotlk[617] = "Dalaran Sewers";
  app.modalConstants.mapWotlk[618] = "The Ring of Valor";
  app.modalConstants.mapWotlk[619] = "Ahn'kahet: The Old Kingdom";
  app.modalConstants.mapWotlk[620] = "Transport: Moa'ki to Unu'pe";
  app.modalConstants.mapWotlk[621] = "Transport: Moa'ki to Kamagua";
  app.modalConstants.mapWotlk[622] = "Transport: Orgrim's Hammer";
  app.modalConstants.mapWotlk[623] = "Transport: The Skybreaker";
  app.modalConstants.mapWotlk[624] = "Vault of Archavon";
  app.modalConstants.mapWotlk[628] = "Isle of Conquest";
  app.modalConstants.mapWotlk[631] = "Icecrown Citadel";
  app.modalConstants.mapWotlk[632] = "The Forge of Souls";
  app.modalConstants.mapWotlk[641] = "Transport: Alliance Airship BG";
  app.modalConstants.mapWotlk[642] = "Transport: HordeAirshipBG";
  app.modalConstants.mapWotlk[647] = "Transport: Orgrimmar to Thunder Bluff";
  app.modalConstants.mapWotlk[649] = "Trial of the Crusader";
  app.modalConstants.mapWotlk[650] = "Trial of the Champion";
  app.modalConstants.mapWotlk[658] = "Pit of Saron";
  app.modalConstants.mapWotlk[668] = "Halls of Reflection";
  app.modalConstants.mapWotlk[672] = "Transport: The Skybreaker (Icecrown Citadel Raid)";
  app.modalConstants.mapWotlk[673] = "Transport: Orgrim's Hammer (Icecrown Citadel Raid)";
  app.modalConstants.mapWotlk[712] = "Transport: The Skybreaker (IC Dungeon)";
  app.modalConstants.mapWotlk[713] = "Transport: Orgrim's Hammer (IC Dungeon)";
  app.modalConstants.mapWotlk[718] = "Trasnport: The Mighty Wind (Icecrown Citadel Raid)";
  app.modalConstants.mapWotlk[723] = "Stormwind";
  app.modalConstants.mapWotlk[724] = "The Ruby Sanctum";
